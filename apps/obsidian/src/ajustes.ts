...
const ETIQUETAS = {
  es: {
    ...
    modeloEmbedDesc: 'Para la memoria de largo plazo y la pestaña consultar. Se descarga solo la primera vez (~600 MB). Vacío = sin memoria.',
  ...
  en: {
    ...
    modeloEmbedDesc: 'For long-term memory and the ask tab. Downloads itself the first time (~600 MB). Empty = no memory.',
